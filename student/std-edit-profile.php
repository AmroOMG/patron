...
if ($selected_id == $student_id) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql2 = "UPDATE users SET first_name = '$first_name', last_name = '$last_name', gender = '$gender', phone = '$phone', bio = '$bio', specialization = '$specialization', image = '$image_name' WHERE id = '$student_id'";
    ...
    header("Location: std-edit-profile.php?id=$student_id");
}
?>
