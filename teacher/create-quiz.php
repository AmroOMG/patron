...
if ($row) {
    ...
    if (isset($_POST['create_quiz'])) {
        ...
        if (!empty($_POST['selected_topic'])) {
            ...
            $sql3 = "INSERT INTO quiz (quiz_title,start_date,start_time,deadline_date,deadline_time,duration,total_mark,subject_id,teacher_id) VALUES ('$quiz_title','$start_date','$start_time','$exp_date','$exp_time','$duration','$mark','$subject_id','$teach_id')";
            if (mysqli_query($conn, $sql3)) {
                $sql4 = "SELECT id FROM quiz WHERE teacher_id=$teach_id ORDER BY id DESC LIMIT 1";
                $result4 = mysqli_query($conn, $sql4);
                $row4 = mysqli_fetch_assoc($result4);
                $quiz_id = $row4['id'];
            } else {
                $error = 'Something went wrong, quiz not added !';
            }
        ...
        <div class="row no-gutters">
            <div class="col">
                <div class="hero hero-subject">
                    <div class="layout">
                        <h3>Subject: <span><?php echo $subject_title; ?></span><br>Create Quiz</h3>
                        ...
                        ?>
                                ...
                                <div class="col-lg-4 col-sm-10">
                                    <div class="topic custom-control custom-checkbox">
                                        <input type="checkbox" name="selected_topic[]" class="custom-control-input" value="<?php echo $topic_id . ',' . $i; ?>" id="<?php echo $topic_id; ?>">
                                        <label class="custom-control-label" for="<?php echo $topic_id; ?>"><?php echo $topic_title; ?></label>
                                        <input type="number" name="questions_count_<?php echo $i; ?>" placeholder="of <?php echo $count; ?>" class="form-control" id="<?php echo $topic_id; ?>">
